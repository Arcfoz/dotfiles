...
$komorebiUrl = "https://api.github.com/repos/LGUG2Z/komorebi/releases/latest"
...
$dotfilesUrl = "https://github.com/arcfoz/dotfiles/archive/refs/heads/main.zip"

# Fetch the latest release information for komorebi, yasb and whkd
Write-Host "Fetching Komorebi release info..." -ForegroundColor Cyan -NoNewline
$komorebiReleaseInfo = Invoke-RestMethod -Uri $komorebiUrl -Headers @{ "User-Agent" = "PowerShell" }
...
$komorebiUrl = $komorebiReleaseInfo.assets | Where-Object { $_.name -like "*x86_64.msi" } | Select-Object -ExpandProperty browser_download_url
...
$komorebiFilePath = Join-Path -Path $sourceFolder -ChildPath "komorebi-latest-x86_64.msi"
